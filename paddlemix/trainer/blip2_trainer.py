...
#import paddlemix
from models.blip2.utils import VQA, VQAEval, coco_caption_eval, save_result
from optimization import FilterParamsName
...
class BLIP2Trainer(Trainer):
    ...
    def create_scheduler(self, num_training_steps):
        lr_sched_func = getattr(optimization, self.args.lr_scheduler_name)
