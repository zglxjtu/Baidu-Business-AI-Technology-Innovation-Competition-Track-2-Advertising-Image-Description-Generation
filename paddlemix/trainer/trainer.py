...
from metrics.clip_zero_shot import ClipZeroShot
#from models.blip2.utils import BlipCollator
#from models.clip.utils import clip_grad_norm
from optimization import create_optimizer_simple
#from trainer.blip2_trainer import BLIP2Trainer
#from trainer.eva02_finetune_trainer import EVA02FinetuneTrainer
from trainer.llava_trainer import LLaVATrainer
#from trainer.minigpt4_trainer import MiniGPT4Trainer
...
def get_trainer(
    ...
    if "clip" in pretrained_model_name_or_path or "coca" in pretrained_model_name_or_path:
        ...
        if "visualglm" in pretrained_model_name_or_path:
        ...
        if "mgen_vl" in pretrained_model_name_or_path:
            collator = MGenVLCollator(train_processor, mode="train")
        else:
            collator = None
