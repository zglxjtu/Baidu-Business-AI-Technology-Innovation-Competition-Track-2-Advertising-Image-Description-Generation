...
VOCAB_FILES_NAMES = {"vocab_file": "mgen.tiktoken", "ttf": "SimSun.ttf"}
...
class MGenVLTokenizer(PretrainedTokenizer):
    """MGen tokenizer."""
    ...
    def __init__(
        ...
        **kwargs
        ...
        enc = tiktoken.Encoding(
            "MGen", pat_str=PAT_STR, mergeable_ranks=self.mergeable_ranks, special_tokens=self.special_tokens
        )
        assert (
    ...
    def save_vocabulary(self, save_directory: str, **kwargs) -> Tuple[str]:
        ...
        """
        file_path = os.path.join(save_directory, "mgen.tiktoken")
        ...
        **kwargs
        ...
        def _encode_imgurl(img_tokens):
            ...
            if len(out_img_tokens) > IMG_TOKEN_SPAN:
                logger.warning(
                    "The content in {}..{} is too long,will use [self.image_pad_tag] * IMG_TOKEN_SPAN replace. make sure use MGenVLProcessor for get input data".format(
